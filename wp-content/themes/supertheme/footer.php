    <footer class="page-footer brown lighten-1">
        <div class="container">
            <div class="row">
                ...
                <div class="gmap col l6 m12 s12">map google</div>
            </div>
        </div>
            ...
            <div class="access-map container">
                <div class="row">
                    <div class="col s12 center">
                        ...
                        <p>
                            <h4><em>Gosselies</em> <img src="img/ZOOPARK-03.svg" alt="logo"></h4><span itemprop="streetAddress">Rue Stranard -</span> <span itemprop="addressLocality">6041 Gosselies -</span> (<span itemprop="addressRegion">Belgique</span>- BE)</p>
